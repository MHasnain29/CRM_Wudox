...
export const SALES_ROLES = ['sales_associate', 'sales_executive', 'sales_manager'];
...
export const ASSOCIATE_LEVEL_ROLES = ['sales_associate', 'sales_executive', 'recruiter', 'sr_recruiter', 'data_entry_specialist'];
