...
export const STATIC_ASSIGNABLE_ROLES: AssignableRoleOption[] = [
  ...
  { key: 'recruiter', name: 'Recruiter', scopeLevel: 'own', sortOrder: 13, isSystem: true, parentKey: 'recruitment_manager' },
  { key: 'sr_recruiter', name: 'Senior Recruiter', scopeLevel: 'own', sortOrder: 14, isSystem: true, parentKey: 'recruitment_manager' },
  { key: 'data_entry_specialist', name: 'Data Entry Specialist', scopeLevel: 'own', sortOrder: 15, isSystem: true, parentKey: 'sales_manager' },
